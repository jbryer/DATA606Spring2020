...
* NY R Conference will be May 8th and 9th. More info here: https://rstats.ai/nyr/ (You can use code landeR2020 for a 20% discount).
* Two new posts on course website:
	* Random numbers: https://spring2020.data606.net/post/2020-01-29-random_numbers_and_seeds/
	* Use of colors: https://spring2020.data606.net/post/2020-03-03-colors/

## Presentations

* 2.1 - Christian Thieme	
* 2.15 - [Umais Siddiqui](https://rpubs.com/umais/data606presentation)
* 2.17 - [Ken Popkin](https://rpubs.com/krpopkin/573749)
* 2.33 - [Leo Yi](https://rpubs.com/data_consumer_101/574214)
